...
void inline hypercall(int type, struct hypercall_args real,
  ...
  asm volatile("vmcall"
               : "+a"(type), "+b"(real.a0), "+c"(real.a1), "+d"(real.a2),
                 "+S"(real.a3));
  asm volatile("vmcall"
               : "+a"(type), "+b"(mispredicted.a0), "+c"(mispredicted.a1),
                 "+d"(mispredicted.a2), "+S"(mispredicted.a3));
}

static ssize_t send_ipi_write(struct file *file, const char __user *buff,
  ...
  struct hypercall_args real = {.a0 = opts[0].mask_low,
                                .a1 = opts[0].mask_high,
                                .a2 = opts[0].min,
                                .a3 = opts[0].icr.raw_icr};

  struct hypercall_args mispredicted = {.a0 = opts[1].mask_low,
                                        .a1 = opts[1].mask_high,
                                        .a2 = opts[1].min,
                                        .a3 = opts[1].icr.raw_icr};
...
static ssize_t sched_yield_write(struct file *file, const char __user *buff,
                                 size_t len, loff_t *off) {
...
static int __init hypercall_main(void) {
  ...
  proc_sched_yield =
      proc_create(procfs_yield_name, 0666, proc_root, &sched_yield_fops);
